...
parser.add_argument('--pretrained_checkpoint', default=None, type=str, help='pretrained checkpoint')
...
if __name__ == '__main__':
    ...
    if args.init_checkpoint is not None:
        ...
        lm_net.load_weight(torch.load(args.pretrained_checkpoint, map_location='cpu'))
        # Then load the LoRA checkpoint
        lm_net.load_weight(torch.load(args.init_checkpoint, map_location='cpu'))
    lm_net = lm_net.cuda()
